...
When you've finished all six, push your repo and make sure the `crunchbot_perception3d` [mini-project](./mini-project/README.md) is in the same workspace — Week 16's fused perception node consumes its clusters and odometry. Then take the [quiz](./quiz.md) with your notes closed.
