...
When you've finished all six, push your repo and make sure the `crunchbot_control` [mini-project](./mini-project/README.md) now hosts all three controllers — PID, LQR, and MPC — for the Phase 3 milestone in Week 24. Then take the [quiz](./quiz.md) with your notes closed.
