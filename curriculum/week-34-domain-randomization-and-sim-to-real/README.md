...
| [resources.md](./resources.md) | The DR papers (Tobin, CAD2RL, Dactyl/ADR), Isaac Lab randomization docs, and the talks worth your time |
| [lecture-notes/01-the-sim-to-real-gap-and-why-randomization-works.md](./lecture-notes/01-the-sim-to-real-gap-and-why-randomization-works.md) | The gap, why fidelity-chasing fails, the canonical recipes, and the three randomization families |
| [lecture-notes/02-randomization-config-adr-and-honest-evaluation.md](./lecture-notes/02-randomization-config-adr-and-honest-evaluation.md) | Implementing the config, ADR, manipulation-vs-nav recipes, the held-out world, and the gap-closure metric |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-randomization-recipe.md](./exercises/exercise-01-randomization-recipe.md) | Decide what to randomize and how wide for two tasks (a grasp and a nav), and justify each choice |
| [exercises/exercise-02-domain-randomization-config.py](./exercises/exercise-02-domain-randomization-config.py) | Implement a parameterized randomization config that samples per-episode world parameters and validate it |
| [exercises/exercise-03-gap-metric.py](./exercises/exercise-03-gap-metric.py) | Compute the sim-to-real gap-closure metric from nominal-vs-randomized held-out evals |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-close-the-gap.md](./challenges/challenge-01-close-the-gap.md) | Augment the Week 28 PPO with randomization, eval on a held-out world, report the gap closed |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the headline gap-closure write-up |
| [mini-project/README.md](./mini-project/README.md) | The `crunchbot_domain_rand` harness: a config-driven randomization layer + gap-closure evaluator |
