...
When you've finished all six, push your repo and make sure the `crunchbot_domain_rand` [mini-project](./mini-project/README.md) is in the same workspace — Week 40's capstone-in-sim and Week 41's safety case both cite gap-closure evidence. Then take the [quiz](./quiz.md) with your notes closed.
