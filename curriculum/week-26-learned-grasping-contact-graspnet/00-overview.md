...
| [resources.md](./01-resources.md) | The Contact-GraspNet paper + code, ACRONYM/GraspNet-1B datasets, MoveIt2 pick docs, SAM2, depth-completion reading |
| [lecture-notes/01-contact-graspnet-architecture.md](./02-lecture-notes/01-contact-graspnet-architecture.md) | The representation, the PointNet++ backbone, the three heads, and pose reconstruction with real PyTorch |
| [lecture-notes/02-deployment-segmentation-and-the-pick-loop.md](./02-lecture-notes/02-deployment-segmentation-and-the-pick-loop.md) | Segmentation-aware grasping, the ROS2 inference node, the MoveIt2 pick pipeline, and the failure buckets |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-pose-reconstruction.md](./03-exercises/exercise-01-pose-reconstruction.md) | Reconstruct a 6-DOF grasp from raw network outputs and verify it against the gripper mesh |
| [exercises/exercise-02-grasp-inference.py](./03-exercises/exercise-02-grasp-inference.py) | Load a Contact-GraspNet checkpoint, run inference on a point cloud, NMS and rank the grasps |
| [exercises/exercise-03-pick-pipeline.py](./03-exercises/exercise-03-pick-pipeline.py) | Filter grasps by IK feasibility and build the pre-grasp/approach/lift sequence for MoveIt2 |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-transparent-object-failure.md](./04-challenges/challenge-01-transparent-object-failure.md) | Reproduce, diagnose, and mitigate the transparent-object failure mode with depth completion |
| [quiz.md](./05-quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the per-object success-rate report |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The `crunchbot_grasp` pick stack: perception → Contact-GraspNet → MoveIt2 → fallback |
