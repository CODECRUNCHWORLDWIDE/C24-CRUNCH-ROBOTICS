...
When you've finished all six, push your repo and make sure the `crunchbot_grasp` [mini-project](./mini-project/README.md) is in the same workspace — Week 27's imitation policy calls it as a skill. Then take the [quiz](./quiz.md) with your notes closed.
