...
If you scored under 9, re-read the lecture for the questions you missed — especially anything about the inertia tensor or the two-universe bridge model, because every later week leans on both. If you scored 12 or 13, you're ready for the [homework](./06-homework.md) and the [crunchbot mini-project](./07-mini-project/00-overview.md).
