...
| [resources.md](./resources.md) | Curated, current (2026) URDF / xacro / Gz Sim / inertia references |
| [lecture-notes/01-a-urdf-is-a-kinematic-claim.md](./lecture-notes/01-a-urdf-is-a-kinematic-claim.md) | URDF schema, links/joints, visual vs. collision, inertia tensors, the explode-on-spawn smell test |
| [lecture-notes/02-gz-sim-plugins-diff-drive-imu-lidar.md](./lecture-notes/02-gz-sim-plugins-diff-drive-imu-lidar.md) | How sensors and actuators get into simulation: DiffDrive, IMU, LiDAR plugins, the bridge, the launch file |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-build-the-diff-drive-body.md](./exercises/exercise-01-build-the-diff-drive-body.md) | Author the chassis, two driven wheels, two casters in xacro |
| [exercises/exercise-02-add-lidar-and-imu.py](./exercises/exercise-02-add-lidar-and-imu.py) | Generate sensor xacro and a bridge config; verify topics populate |
| [exercises/exercise-03-spawn-and-drive.py](./exercises/exercise-03-spawn-and-drive.py) | A launch file that spawns the robot and a node that drives it via `/cmd_vel` |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-fix-the-exploding-robot.md](./challenges/challenge-01-fix-the-exploding-robot.md) | Diagnose and repair a provided URDF that explodes on spawn |
| [quiz.md](./quiz.md) | 13 questions with an answer key |
| [homework.md](./homework.md) | Five practice problems with a rubric |
| [mini-project/README.md](./mini-project/README.md) | Full spec for **crunchbot**, the Phase-1 platform |
