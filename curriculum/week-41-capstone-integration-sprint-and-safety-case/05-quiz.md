...
If you scored under 10, re-read the lecture for the questions you missed before starting the mini-project — the case you write this weekend rests on exactly these concepts. If you scored 12+, you're ready for the [homework](./06-homework.md) and the [mini-project](./07-mini-project/00-overview.md).
