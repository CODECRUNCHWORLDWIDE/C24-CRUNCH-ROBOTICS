...
When you've finished all six, you have most of the mini-project's raw material already in `safety-case/`. Push your repo and open the [mini-project](./mini-project/README.md) — the weekend's job is assembling these pieces into one coherent, signed safety case.
