...
| [resources.md](./01-resources.md) | The Open-RMF docs, the MRTA taxonomy papers, the auction literature, and the talks worth your time |
| [lecture-notes/01-task-allocation-hungarian-and-markets.md](./02-lecture-notes/01-task-allocation-hungarian-and-markets.md) | The MRTA taxonomy, the Hungarian algorithm, market/auction allocation, and the optimality trade-off |
| [lecture-notes/02-open-rmf-fleet-management-and-reallocation.md](./02-lecture-notes/02-open-rmf-fleet-management-and-reallocation.md) | The Open-RMF architecture, fleet adapters, the traffic schedule, conflict negotiation, and failure reallocation |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-cost-matrix-on-paper.md](./03-exercises/exercise-01-cost-matrix-on-paper.md) | Build a cost matrix from robot/task poses, solve it greedily and Hungarian, and prove greedy is sub-optimal |
| [exercises/exercise-02-hungarian-allocator.py](./03-exercises/exercise-02-hungarian-allocator.py) | A runnable Hungarian allocator node: cost matrix from poses, optimal assignment, rectangular padding |
| [exercises/exercise-03-ssi-auction.py](./03-exercises/exercise-03-ssi-auction.py) | A sequential-single-item auction allocator that re-bids on task arrival and robot dropout |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-corridor-deadlock.md](./04-challenges/challenge-01-corridor-deadlock.md) | Make two robots contend for one corridor under your allocator; detect the deadlock and prescribe the deconfliction |
| [quiz.md](./05-quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the reallocation-drill write-up |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The `crunch_fleet` dispatcher: cost-matrix allocation + a heartbeat-driven failure detector + a reallocation drill |
