...
When you've finished all six, push your repo and make sure the `crunch_fleet` [mini-project](./mini-project/README.md) is in the same workspace — the capstone reuses its heartbeat schema. Then take the [quiz](./quiz.md) with your notes closed.
