...
Next: the exercises put PPO and SAC in your hands on CartPole and Pendulum, then the challenge makes you hunt reward hacks, and the mini-project trains a reach policy to >90% and wraps it in ROS2. Continue to [the exercises](../03-exercises/00-overview.md).
