...
When you've finished all six, push your repo and make sure the mini-project's training run and ROS2 node are in the same workspace — Week 32 compares against them. Then take the [quiz](./05-quiz.md) with your notes closed.
