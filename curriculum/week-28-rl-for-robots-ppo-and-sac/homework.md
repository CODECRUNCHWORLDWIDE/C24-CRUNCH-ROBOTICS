...
**Hint.** A reviewer reads this in three minutes and decides whether to trust your policy. The trace readings are what build that trust — a report that says "explained_variance climbed to 0.94, so the critic learned the returns" reads like an engineer; "the graphs look good" reads like a learner.
