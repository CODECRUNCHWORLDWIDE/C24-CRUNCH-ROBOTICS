...
When you've finished all six, push your repo and make sure the `crunchbot_control` [mini-project](./07-mini-project/00-overview.md) now hosts both the PID and the LQR — Week 22 adds MPC to the same package. Then take the [quiz](./05-quiz.md) with your notes closed.
