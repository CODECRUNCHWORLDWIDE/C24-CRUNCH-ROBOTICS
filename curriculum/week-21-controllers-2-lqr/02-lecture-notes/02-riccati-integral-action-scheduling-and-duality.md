...
Next: the exercises put all of this on your robot — build the model, solve for `K`, and race LQR against the PID on a curve. Continue to [the exercises](../03-exercises/00-overview.md).
