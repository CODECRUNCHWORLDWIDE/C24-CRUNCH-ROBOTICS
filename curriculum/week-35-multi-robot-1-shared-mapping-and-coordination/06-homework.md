...
When you've finished all six, push your repo and make sure the `crunchbot_multi` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 36 builds the fleet manager on top of it. Then take the [quiz](./05-quiz.md) with your notes closed.
