...
When you've finished all six, push your repo and make sure the `crunch_perception` [mini-project](./mini-project/README.md) is in the same workspace — and that `perception-brief.md` is ready to present. Then take the [quiz](./quiz.md) with your notes closed, and schedule your midterm defense.
