...
**Q3.** A learner reports "my perception is 12 ms" — the YOLO inference time. The panel asks "from the sensor stamp, under load, p95?" The learner's number was wrong because:
