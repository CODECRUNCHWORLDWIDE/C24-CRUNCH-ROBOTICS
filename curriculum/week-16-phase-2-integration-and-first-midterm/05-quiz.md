...
If you scored under 9, re-read the lectures for the questions you missed — especially Lecture 1 on the latency budget and Lecture 2 on data association and the defense. If you scored 11 or higher, you're ready to defend the milestone: head to the [homework](./06-homework.md) and the [mini-project](./07-mini-project/00-overview.md).
