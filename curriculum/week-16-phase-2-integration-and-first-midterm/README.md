...
| [resources.md](./resources.md) | The integration, latency-profiling, data-association, and architecture-review references that matter in 2026 — ROS2 Jazzy docs, `vision_msgs`, REP 105, profiling tools, and the systems-integration talks |
| [lecture-notes/01-perception-pipeline-design-and-the-latency-budget.md](./lecture-notes/01-perception-pipeline-design-and-the-latency-budget.md) | The end-to-end perception graph, the interface contract, drawing the latency block diagram, measuring end-to-end latency, and the four integration defects |
| [lecture-notes/02-the-midterm-defense-and-the-architecture-review.md](./lecture-notes/02-the-midterm-defense-and-the-architecture-review.md) | The architecture-review format, the perception architecture brief, data association, the robustness gates, defending a number, and the hard-gate consequences |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-draw-the-latency-budget.md](./exercises/exercise-01-draw-the-latency-budget.md) | Guided: turn your perception graph into an interface-contract table and a latency block diagram with a measured budget per hop |
| [exercises/exercise-02-perception-latency-probe.py](./exercises/exercise-02-perception-latency-probe.py) | Runnable: a probe node that measures sensor-stamp-to-publish latency end-to-end, reports the p50/p95/p99 distribution, and flags budget blowouts |
| [exercises/exercise-03-detection-cluster-association.py](./exercises/exercise-03-detection-cluster-association.py) | Runnable: associate 2D detections with 3D clusters into fused objects, with the no-match / double-match failure modes handled |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-defend-the-perception-stack.md](./challenges/challenge-01-defend-the-perception-stack.md) | A full midterm-defense rehearsal: present the architecture brief and answer a panel's questions against the rubric |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the perception architecture brief, with a rubric |
| [mini-project/README.md](./mini-project/README.md) | Full spec for the **Phase 2 milestone** — the fused perception node publishing `/perception/objects` inside a measured latency budget, defended at the first midterm |
