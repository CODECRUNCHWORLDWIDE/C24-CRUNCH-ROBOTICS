...
Next: the exercises build the skill library, the constrained planner, and the grounded executor; the mini-project assembles the local-LLM grounded planner end-to-end. Continue to [the exercises](../03-exercises/00-overview.md).
