...
When you've finished all six, push your repo and make sure the `crunch_planner` [mini-project](./mini-project/README.md) is in the same workspace — the capstone reuses it as the task layer. This closes Phase 5: next week (39) profiles the whole AI stack on the edge, and Week 40 unseals the capstone. Then take the [quiz](./quiz.md) with your notes closed.
