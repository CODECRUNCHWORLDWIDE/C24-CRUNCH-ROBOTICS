...
| [resources.md](./01-resources.md) | SayCan/grounded-planning papers, the C23 bridge material, constrained-decoding tools, local-LLM deployment, and the talks worth your time |
| [lecture-notes/01-llm-as-planner-saycan-and-skill-libraries.md](./02-lecture-notes/01-llm-as-planner-saycan-and-skill-libraries.md) | LLM-as-planner, SayCan's Say×Can, the skill library, and the C23 tool-use lineage |
| [lecture-notes/02-grounding-constrained-output-and-safety.md](./02-lecture-notes/02-grounding-constrained-output-and-safety.md) | Constrained-grammar output, runtime grounding/validation, the executor, closed-loop re-planning, local deploy, and safety in language space |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-skill-library-design.md](./03-exercises/exercise-01-skill-library-design.md) | Design a typed skill library with preconditions/effects; write the grammar that constrains the planner to it |
| [exercises/exercise-02-constrained-planner.py](./03-exercises/exercise-02-constrained-planner.py) | A planner that emits a JSON-schema-constrained skill sequence and validates it against the library + world state |
| [exercises/exercise-03-grounded-executor.py](./03-exercises/exercise-03-grounded-executor.py) | The executor: run a plan skill-by-skill, ground each against world state, re-plan on a skill failure |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-ungrounded-plan.md](./04-challenges/challenge-01-ungrounded-plan.md) | Make the planner emit plausible-but-ungrounded plans; build the validator that catches each class of ungroundedness |
| [quiz.md](./05-quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the grounded-planner demo write-up |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The `crunch_planner`: a local-LLM grounded planner with a skill library, grammar constraint, runtime grounding, and closed-loop re-planning |
