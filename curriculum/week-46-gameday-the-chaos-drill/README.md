...
| [resources.md](./resources.md) | Chaos-engineering, watchdog, Nav2-recovery, and postmortem references, current to 2026 |
| [lecture-notes/01-chaos-engineering-for-robots.md](./lecture-notes/01-chaos-engineering-for-robots.md) | The chaos method adapted to robots; watchdogs, health aggregation, and graceful degradation |
| [lecture-notes/02-the-two-drills-and-the-postmortem.md](./lecture-notes/02-the-two-drills-and-the-postmortem.md) | Both drills end to end, the recovery ladders, the 60-second bar, and the postmortem template |
| [exercises/README.md](./exercises/README.md) | Index of this week's three exercises |
| [exercises/exercise-01-design-the-drill.md](./exercises/exercise-01-design-the-drill.md) | Write the steady-state hypothesis, blast radius, and abort plan for both drills |
| [exercises/exercise-02-sensor-watchdog.py](./exercises/exercise-02-sensor-watchdog.py) | A runnable sensor watchdog + health aggregator that detects dropout and emits degraded mode |
| [exercises/exercise-03-deadlock-detector.py](./exercises/exercise-03-deadlock-detector.py) | A runnable planner-deadlock detector that trips a timeout and walks the recovery ladder |
| [challenges/README.md](./challenges/README.md) | Index of this week's challenge |
| [challenges/challenge-01-survive-gameday.md](./challenges/challenge-01-survive-gameday.md) | Run both live drills, recover inside 60 s with operator-detectable events, write both postmortems |
| [quiz.md](./quiz.md) | 13 questions with an answer key |
| [homework.md](./homework.md) | Concrete deliverables with a grading rubric |
| [mini-project/README.md](./mini-project/README.md) | The reproducible chaos harness + the two graded postmortems |
