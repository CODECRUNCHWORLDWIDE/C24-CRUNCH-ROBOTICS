...
| [resources.md](./resources.md) | The VLA papers (RT-2, RT-X, OpenVLA, π0), the open-vocab detectors, the eval harnesses, and the talks worth your time |
| [lecture-notes/01-vlms-to-vlas-architecture-and-grounding.md](./lecture-notes/01-vlms-to-vlas-architecture-and-grounding.md) | From VLM to VLA, action-as-tokens, cross-embodiment, and how language grounds to the scene |
| [lecture-notes/02-vla-as-policy-evaluation-and-the-safety-leash.md](./lecture-notes/02-vla-as-policy-evaluation-and-the-safety-leash.md) | The integration loop, evaluation, the failure taxonomy, the safety leash, and edge latency |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-prompt-and-ground.md](./exercises/exercise-01-prompt-and-ground.md) | Run a VLM/VLA on images + instructions; observe implicit grounding and its failures by hand |
| [exercises/exercise-02-open-vocab-grounding.py](./exercises/exercise-02-open-vocab-grounding.py) | An open-vocab grounding node: instruction → detected target box + mask, with a confidence you can gate on |
| [exercises/exercise-03-vla-policy-loop.py](./exercises/exercise-03-vla-policy-loop.py) | The VLA-as-policy loop with a verification gate that rejects when grounding disagrees and falls back |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-hallucination-hunt.md](./challenges/challenge-01-hallucination-hunt.md) | Engineer adversarial scenes that make the VLA confidently wrong; build the gate that catches each |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the language-conditioned failure analysis |
| [mini-project/README.md](./mini-project/README.md) | The `crunch_vla` language-conditioned manipulation node with grounding gate, fallback, and an instruction-suite eval |
