...
When you've finished all six, push your repo and make sure the `crunch_vla` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — the capstone reuses its gate and instruction suite. Then take the [quiz](./05-quiz.md) with your notes closed.
