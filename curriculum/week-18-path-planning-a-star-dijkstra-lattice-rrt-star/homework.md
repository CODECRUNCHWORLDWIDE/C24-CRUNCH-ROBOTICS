...
When you've finished all six, push your repo and make sure the `crunch_planners` [mini-project](./mini-project/README.md) is in the same workspace — Week 24's integration imports it. Then take the [quiz](./quiz.md) with your notes closed.
