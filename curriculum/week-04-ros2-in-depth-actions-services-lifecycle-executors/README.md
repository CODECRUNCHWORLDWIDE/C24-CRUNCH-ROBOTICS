...
| [resources.md](./resources.md) | The ROS2 Jazzy docs that matter, the design articles, the talks, and the source to read |
| [lecture-notes/01-the-decision-ladder.md](./lecture-notes/01-the-decision-ladder.md) | Topic → service → action → behavior tree. When each is right, services in depth, and the "don't block in a callback" rule that forces you up the ladder |
| [lecture-notes/02-lifecycle-executors-callback-groups.md](./lecture-notes/02-lifecycle-executors-callback-groups.md) | Executors, callback groups, the cancel deadlock and its fix, lifecycle nodes, composition, and why managed nodes matter for safety |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-decision-ladder-and-service.md](./exercises/exercise-01-decision-ladder-and-service.md) | Guided: classify ten problems on the ladder, then write a `ResetOdometry` service server + client |
| [exercises/exercise-02-spin90-action-server.py](./exercises/exercise-02-spin90-action-server.py) | Runnable: a `Spin90Degrees` action server with closed-loop IMU yaw and preemption |
| [exercises/exercise-03-multithreaded-executor.py](./exercises/exercise-03-multithreaded-executor.py) | Runnable: run the server under a `MultiThreadedExecutor` with a reentrant callback group for the cancel path |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-lifecycle-spin90.md](./challenges/challenge-01-lifecycle-spin90.md) | Convert `Spin90Degrees` into a managed lifecycle node that refuses goals while inactive |
...
| [mini-project/README.md](./mini-project/README.md) | Full spec for the "motion primitives" action package — `RotateByAngle` + `DriveStraightDistance`, preemptible, lifecycle-managed, composed into one process |
