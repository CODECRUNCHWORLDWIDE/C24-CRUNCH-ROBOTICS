...
Next: the exercises put the CVAE and temporal ensembling in your hands, the challenge stages the rigorous latency shootout, and the mini-project trains ACT on your demos and produces the comparison table. Continue to [the exercises](../03-exercises/00-overview.md).
