...
If you scored under 8, re-read lecture 1 (the tf2 section) and lecture 2 (SE(3) and the adjoint) for the questions you missed. If you scored 10 or higher, you're ready for the [homework](./homework.md) and the [mini-project](./mini-project/README.md).
