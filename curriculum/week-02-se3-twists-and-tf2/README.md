...
| [resources.md](./resources.md) | Curated SE(3) references, the tf2 docs, Modern Robotics, real talks |
| [lecture-notes/01-every-transform-problem-is-a-tree-problem.md](./lecture-notes/01-every-transform-problem-is-a-tree-problem.md) | The tf2 mental model: buffers, lookups, time-travel, broadcasters, the three exceptions |
| [lecture-notes/02-se3-twists-and-adjoints.md](./lecture-notes/02-se3-twists-and-adjoints.md) | Rigid-body motion as exponential coordinates: SE(3), twists, the exp/log maps, adjoints |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-four-link-static-tree.md](./exercises/exercise-01-four-link-static-tree.md) | Build a `base → shoulder → elbow → wrist` tf2 tree with `static_transform_publisher` per joint |
| [exercises/exercise-02-dynamic-broadcaster.py](./exercises/exercise-02-dynamic-broadcaster.py) | Add a dynamic broadcaster for one rotating joint; confirm the moving frame in rviz2 |
...
| [challenges/challenge-01-induce-and-fix-extrapolation.md](./challenges/challenge-01-induce-and-fix-extrapolation.md) | Deliberately trigger an `ExtrapolationException`, then fix it; document before/after |
| [quiz.md](./quiz.md) | 12 multiple-choice questions with an answer key |
| [homework.md](./homework.md) | Six practice problems for the week |
| [mini-project/README.md](./mini-project/README.md) | Full spec for the reusable launch file + tree-health monitor node |
