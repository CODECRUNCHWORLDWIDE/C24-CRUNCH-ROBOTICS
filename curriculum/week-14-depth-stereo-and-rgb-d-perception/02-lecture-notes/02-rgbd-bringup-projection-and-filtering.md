...
Next: the exercises put all of this on a real (or simulated) RGB-D camera, and the mini-project packages it into a `crunchbot_rgbd` bring-up whose confidence-gated cloud feeds directly into next week's Open3D/PCL processing. Continue to [the exercises](../03-exercises/00-overview.md).
