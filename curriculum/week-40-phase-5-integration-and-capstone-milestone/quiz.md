...
If you scored under 9, re-read the lectures for the questions you missed — especially Lecture 1 on reading the spec and Lecture 2 on the pre-flight ritual. If you scored 11 or higher, you are ready to stand the system up: head to the [homework](./homework.md) and the [mini-project](./mini-project/README.md).
