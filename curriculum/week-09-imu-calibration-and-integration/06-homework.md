...
When you've finished all six, push your repo and make sure the `crunch_imu_calib` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 10 fuses its output. Then take the [quiz](./05-quiz.md) with your notes closed.
