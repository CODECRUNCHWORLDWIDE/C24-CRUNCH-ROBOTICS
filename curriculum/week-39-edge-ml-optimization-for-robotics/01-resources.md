...
- **Yang et al., "Depth Anything V2" (2024)** — the depth model you may distill; read for the teacher-student setup:
...
| **Distillation** | Training a small "student" to mimic a large "teacher" model's soft outputs. |
