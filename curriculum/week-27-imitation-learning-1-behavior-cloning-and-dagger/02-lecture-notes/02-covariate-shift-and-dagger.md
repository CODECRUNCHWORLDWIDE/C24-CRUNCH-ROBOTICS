...
Next: the exercises collect demos, train the BC policy, watch it drift, and fix it with DAgger; the mini-project builds the whole pipeline with an honest eval and a safety wrapper. Continue to [the exercises](../03-exercises/00-overview.md).
