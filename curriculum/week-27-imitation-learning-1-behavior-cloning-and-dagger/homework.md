...
When you've finished all six, push your repo and make sure the `crunch_il` [mini-project](./mini-project/README.md) is in the same workspace — Week 29 trains a Diffusion Policy on the same demonstrations and compares against your BC+DAgger baseline. Then take the [quiz](./quiz.md) with your notes closed.
