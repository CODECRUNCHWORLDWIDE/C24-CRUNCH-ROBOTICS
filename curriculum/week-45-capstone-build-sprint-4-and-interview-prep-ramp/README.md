...
| [resources.md](./resources.md) | Curated, current (2026) interview-prep and system-design references |
| [lecture-notes/01-robotics-startup-system-design-on-the-whiteboard.md](./lecture-notes/01-robotics-startup-system-design-on-the-whiteboard.md) | The requirements-first method, the budgets, the box diagram, and the warehouse-AMR prompt worked end to end |
| [lecture-notes/02-the-robotics-technical-interview.md](./lecture-notes/02-the-robotics-technical-interview.md) | Kinematics, controls, sensor fusion, the EKF on the board, and the five-projects résumé conversation |
| [exercises/README.md](./exercises/README.md) | Index of this week's three exercises |
| [exercises/exercise-01-system-design-mock.md](./exercises/exercise-01-system-design-mock.md) | Run a system-design mock with a peer (design a warehouse-AMR autonomy stack) |
| [exercises/exercise-02-ekf-predict-on-the-board.py](./exercises/exercise-02-ekf-predict-on-the-board.py) | Write and verify the EKF predict step you will reproduce on the whiteboard |
| [exercises/exercise-03-self-grade-mocks.py](./exercises/exercise-03-self-grade-mocks.py) | Score both mocks against the rubric and rank your weakest topics |
| [challenges/README.md](./challenges/README.md) | Index of this week's challenge |
| [challenges/challenge-01-defend-your-stack.md](./challenges/challenge-01-defend-your-stack.md) | Defend a probed capstone decision through three layers of "why" |
| [quiz.md](./quiz.md) | 13 questions with an answer key |
| [homework.md](./homework.md) | Concrete deliverables with a grading rubric |
| [mini-project/README.md](./mini-project/README.md) | Two graded mock interviews + a targeted study plan for Week 47 |
