...
Answers are in the quiz and the challenge. When you can flip authority cleanly in both directions with the banner changing on the dashboard, you are ready for [Challenge 1](../04-challenges/challenge-01-clean-takeover-and-return.md).
