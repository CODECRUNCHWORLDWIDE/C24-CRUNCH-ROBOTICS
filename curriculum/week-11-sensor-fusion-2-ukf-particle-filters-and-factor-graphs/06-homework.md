...
When you've finished all six, push your repo and make sure the `crunch_posegraph` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 16 imports its ideas. Then take the [quiz](./05-quiz.md) with your notes closed.
