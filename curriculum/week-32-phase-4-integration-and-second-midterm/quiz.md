...
If you scored under 9, re-read the lecture sections cited in the answers you missed — especially Lecture 1 on the leash and the four defects, and Lecture 2 on the predictive filter and the midterm defense. If you scored 11 or higher, you're ready for the [homework](./homework.md) and the [mini-project](./mini-project/README.md) — and the midterm review.
