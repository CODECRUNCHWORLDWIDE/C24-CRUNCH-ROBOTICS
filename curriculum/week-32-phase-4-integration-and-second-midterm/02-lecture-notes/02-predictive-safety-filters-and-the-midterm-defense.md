...
Next: the exercises build the constraint set, the predictive filter, and the intervention meter; the challenge is a dry run of the midterm defense; the mini-project is the wrapped policy you defend. Continue to [the exercises](../03-exercises/00-overview.md).
