...
When you've finished all six, push your repo and make sure the `crunchbot_sim_compare` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 34 extends it into a domain-randomization harness. Then take the [quiz](./05-quiz.md) with your notes closed.
