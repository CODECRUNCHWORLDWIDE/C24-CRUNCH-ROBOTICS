...
When you've finished all six, push your repo and make sure the `crunchbot_vla_eval` [mini-project](./mini-project/README.md) is in the same workspace — Week 32's midterm and Week 44's capstone eval both build on it. Then take the [quiz](./quiz.md) with your notes closed.
