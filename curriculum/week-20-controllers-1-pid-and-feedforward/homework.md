...
When you've finished all six, push your repo and make sure the `crunchbot_control` [mini-project](./mini-project/README.md) is in the same workspace — Week 21 imports it to compare LQR against this PID. Then take the [quiz](./quiz.md) with your notes closed.
