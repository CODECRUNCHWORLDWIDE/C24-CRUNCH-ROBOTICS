...
| [resources.md](./resources.md) | The BehaviorTree.CPP docs, the Groot 2 docs, the Nav2 BT reference, the canonical BT book, and the talks worth your time |
| [lecture-notes/01-behavior-trees-vs-state-machines.md](./lecture-notes/01-behavior-trees-vs-state-machines.md) | BTs vs FSMs, ticking semantics, the three statuses, the control nodes, decorators, and conditions |
| [lecture-notes/02-behaviortree-cpp-groot-and-the-patrol-task.md](./lecture-notes/02-behaviortree-cpp-groot-and-the-patrol-task.md) | Authoring in BehaviorTree.CPP, custom C++ nodes, the blackboard, Groot 2, and the patrol-with-yield task |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-read-and-trace-trees.md](./exercises/exercise-01-read-and-trace-trees.md) | Trace five small trees by hand, predict the tick sequence, then verify in Groot 2 |
| [exercises/exercise-02-tick-engine.py](./exercises/exercise-02-tick-engine.py) | A runnable, correct minimal BT tick engine (Sequence/Fallback/Parallel/decorators) with a self-checking harness |
| [exercises/exercise-03-patrol-blackboard.py](./exercises/exercise-03-patrol-blackboard.py) | A runnable patrol-with-yield simulation showing reactive yielding and the 60 s retreat, blackboard-driven |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-the-misbehaving-tree.md](./challenges/challenge-01-the-misbehaving-tree.md) | A patrol tree with three structural bugs (a non-reactive yield, a missing timeout, an inverted condition) — diagnose and fix using Groot 2 |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the fail-safe-as-a-visible-branch declaration |
| [mini-project/README.md](./mini-project/README.md) | The `crunchbot_patrol` package: the full BT.CPP patrol-with-yield-and-retreat, wired to Nav2 + perception, audited in Groot 2 |
