...
| [resources.md](./01-resources.md) | The Diffusion Policy + DDPM/DDIM papers, the LeRobot library, the diffusers docs, and the talks worth your time |
| [lecture-notes/01-the-multimodal-problem-and-ddpm.md](./02-lecture-notes/01-the-multimodal-problem-and-ddpm.md) | The multimodal-action problem, DDPM forward/reverse processes, the ε-prediction loss, and DDIM sampling |
| [lecture-notes/02-diffusion-policy-chunking-and-deployment.md](./02-lecture-notes/02-diffusion-policy-chunking-and-deployment.md) | The Diffusion Policy architecture, action chunking, receding-horizon execution, conditioning, and ROS2 deployment |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-ddpm-ddim-math.md](./03-exercises/exercise-01-ddpm-ddim-math.md) | Derive the closed-form $q(x_t\mid x_0)$, the ε-loss, and the DDIM update; predict step-count effects |
| [exercises/exercise-02-toy-diffusion.py](./03-exercises/exercise-02-toy-diffusion.py) | A runnable 1D diffusion model that learns a bimodal distribution; you fill the noising and the ε-loss |
| [exercises/exercise-03-diffusion-policy.py](./03-exercises/exercise-03-diffusion-policy.py) | A runnable Diffusion Policy on a 2D multimodal toy task with chunking + receding horizon; you fill the conditioned loss and the DDIM action sampler |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-multimodal-showdown.md](./04-challenges/challenge-01-multimodal-showdown.md) | Build a deliberately multimodal task, show BC collapses to the mean, show Diffusion Policy doesn't |
| [quiz.md](./05-quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the eval-report writeup with a rubric |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Train a Diffusion Policy on the Week-27 demos, beat BC and BC+DAgger, deploy it receding-horizon in ROS2 |
