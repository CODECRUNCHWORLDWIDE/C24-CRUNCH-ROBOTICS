...
| [resources.md](./resources.md) | The `robot_localization` docs, Kalman-filter references, REP 105, and the talks worth your time |
| [lecture-notes/01-kalman-and-ekf-from-scratch.md](./lecture-notes/01-kalman-and-ekf-from-scratch.md) | Bayesian filtering, the KF predict/update, the EKF and its Jacobians, Q and R |
| [lecture-notes/02-robot-localization-in-practice.md](./lecture-notes/02-robot-localization-in-practice.md) | `ekf_node` config, the boolean matrices, REP 105 frames, fusing odom + IMU, tuning |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-read-an-ekf-config.md](./exercises/exercise-01-read-an-ekf-config.md) | Read a real `ekf.yaml` and predict exactly what it fuses and what TF it publishes |
| [exercises/exercise-02-scalar-kalman.py](./exercises/exercise-02-scalar-kalman.py) | Implement a 1-D Kalman filter from scratch; watch covariance shrink on update, grow on predict |
| [exercises/exercise-03-fuse-odom-imu.py](./exercises/exercise-03-fuse-odom-imu.py) | A `robot_localization` launch + config harness and a drift-comparison subscriber |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-tune-and-quantify-fusion.md](./challenges/challenge-01-tune-and-quantify-fusion.md) | Tune process noise and prove fused drift beats raw odometry on the Week 6 square |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the EKF tuning-rationale write-up |
| [mini-project/README.md](./mini-project/README.md) | The `crunch_localization` package: a tuned EKF fusing odom + IMU with a documented config and drift proof |
