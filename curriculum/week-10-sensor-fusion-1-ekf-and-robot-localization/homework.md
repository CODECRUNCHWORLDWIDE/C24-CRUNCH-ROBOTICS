...
When you've finished all six, push your repo and make sure the `crunch_localization` [mini-project](./mini-project/README.md) is in the same workspace — Week 11 adds AMCL on top of it. Then take the [quiz](./quiz.md) with your notes closed.
