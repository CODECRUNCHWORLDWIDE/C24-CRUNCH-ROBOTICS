...
| [resources.md](./resources.md) | The ROS2 QoS docs, DDS specs, vendor docs, and the talks worth your time |
| [lecture-notes/01-qos-is-not-optional.md](./lecture-notes/01-qos-is-not-optional.md) | The six policies, the compatibility rules, the built-in profiles, and the topic-class taste test |
| [lecture-notes/02-dds-discovery-vendors-message-design.md](./lecture-notes/02-dds-discovery-vendors-message-design.md) | DDS discovery, CycloneDDS vs Fast-DDS, rmw introspection, and message-design idioms |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-sensor-qos.md](./exercises/exercise-01-sensor-qos.md) | Set the robot's sensor topics to `BEST_EFFORT`/`KEEP_LAST`/depth 5 and verify with `ros2 topic info -v` |
| [exercises/exercise-02-latched-map.py](./exercises/exercise-02-latched-map.py) | A `TRANSIENT_LOCAL` map publisher + a late subscriber that still receives the latched map |
| [exercises/exercise-03-mismatch-probe.py](./exercises/exercise-03-mismatch-probe.py) | Introduce a deliberate QoS mismatch and capture the silent failure with rmw incompatibility events |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-diagnose-three-mismatches.md](./challenges/challenge-01-diagnose-three-mismatches.md) | Detect and prescribe the fix for three different QoS-mismatch scenarios on a live graph |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the one-page mismatch postmortem |
| [mini-project/README.md](./mini-project/README.md) | The reusable `crunchbot_qos` profile module + live-graph auditor |
