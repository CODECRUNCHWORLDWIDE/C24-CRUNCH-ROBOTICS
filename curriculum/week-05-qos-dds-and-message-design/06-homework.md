...
When you've finished all six, push your repo and make sure the `crunchbot_qos` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 8 imports it. Then take the [quiz](./05-quiz.md) with your notes closed.
