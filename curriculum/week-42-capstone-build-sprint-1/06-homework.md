...
When you have finished all five, push your `capstone/sprint-01/` directory and open the [mini-project](./07-mini-project/00-overview.md) to assemble them into the graded sprint artifact.
