...
Next: the exercises put the geometry on a real cloud, and the mini-project builds the `crunch_grasp` planner end to end. Continue to [the exercises](../03-exercises/00-overview.md).
