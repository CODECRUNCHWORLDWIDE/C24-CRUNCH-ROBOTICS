...
| [resources.md](./01-resources.md) | The grasp-mechanics references, the dataset and planner papers, the Open3D and gripper-geometry docs, and the talks worth your time |
| [lecture-notes/01-grasp-mechanics-force-closure-antipodal.md](./02-lecture-notes/01-grasp-mechanics-force-closure-antipodal.md) | Force/form closure, the friction-cone contact model, antipodal grasps, and the candidate-sampling algorithm |
| [lecture-notes/02-gripper-frame-scoring-and-the-landscape.md](./02-lecture-notes/02-gripper-frame-scoring-and-the-landscape.md) | The gripper-frame convention, building and transforming the grasp pose, scoring/ranking/reachability, and the 2026 dataset + learned-planner landscape |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-force-closure-by-hand.md](./03-exercises/exercise-01-force-closure-by-hand.md) | Determine force closure for 2D grasps by hand, with the friction cone, then check your answers in code |
| [exercises/exercise-02-antipodal-sampler.py](./03-exercises/exercise-02-antipodal-sampler.py) | Sample and score antipodal grasp candidates on a tabletop point cloud; print a ranked top-10 |
| [exercises/exercise-03-grasp-to-pose.py](./03-exercises/exercise-03-grasp-to-pose.py) | Turn an antipodal pair into a gripper-frame SE(3) grasp pose and a `PoseStamped` for MoveIt2 |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-grasp-three-objects.md](./04-challenges/challenge-01-grasp-three-objects.md) | Generate, rank, and visualize reachable grasps for three different objects, and defend why the top grasp is the top grasp |
| [quiz.md](./05-quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the grasp-failure postmortem |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The `crunch_grasp` analytic grasp planner: cloud in, ranked reachable grasps out, top-10 visualized in rviz2 |
