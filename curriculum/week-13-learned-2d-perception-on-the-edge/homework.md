...
When you've finished all six, push your repo and make sure the `crunch_detector` [mini-project](./mini-project/README.md) is in the same workspace — Week 16 fuses its detections into the perception graph. Then take the [quiz](./quiz.md) with your notes closed.
