...
Next: the exercises put all of this on a real UR5e — you'll build the FK by hand, watch your DLS solver survive a singularity, and dispatch a pose goal from a topic into a live plan-and-execute. Continue to [the exercises](../03-exercises/00-overview.md).
